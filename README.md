...
Target-specific research, tooling, and analysis for **Pocket Monsters Ao / Pokémon Blue**.
...
| Intended scope | Japanese and localized Blue releases, with regional relationships verified before shared-source assumptions. |
