; Byte-identical 200-byte tileset collision lists in all six source ROMs.
; SHA-1 of the encoded data: af69e30d0ddd85bf0f2be3fe6182073a5acc8099

IF DEF(_JP)
SECTION "Tileset collision IDs", ROM0[$1724]
ELIF DEF(_FR)
SECTION "Tileset collision IDs", ROM0[$172c]
ELSE
SECTION "Tileset collision IDs", ROM0[$172f]
ENDC
